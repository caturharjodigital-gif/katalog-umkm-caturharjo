	...
	<div class="mx-auto max-w-7xl px-5 py-10 md:px-8">
		<div class="flex flex-col items-center gap-4 text-center">
			<div class="flex items-center gap-3">
				<a href="https://www.instagram.com/oppc_caturharjo?stkn=N2VnbnUyYTdtcWY1" target="_blank" rel="noreferrer" aria-label="Instagram" class="flex items-center justify-center gap-2 rounded-full text-white transition">
					<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 264.583 264.583">
						<path d="M0 0h264.583v264.583H0z" fill="none" />
						<defs>
				...
				<a href="mailto:caturharjodigital@gmail.com" aria-label="Email" class="flex gap-2 items-center justify-center text-white transition">
					<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 32 32">
						<path d="M0 0h32v32H0z" fill="none" />
						<path fill="#42a5f5" d="M28 6H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2m0 6l-12 6l-12-6V8l12 6l12-6Z" />
					</svg>
					caturharjodigital@gmail.com
				</a>
			</div>
			...
			<!-- Copyright -->
			<p class="text-xs md:text-sm text-white/60">©{year} KKN-M 29921 UNY CATURHARJO & OPPC</p>
